    ...
    return (
      <div className="glass-card" style={{
        ...
        <div style={{
          ...
          <Music size={30} color="#397D9F" />
        </div>

        <h3 className="font-serif" style={{ color: '#263B46', fontSize: '1.6rem' }}>
          Music Room Ready
        </h3>

        <p style={{ color: '#607782', lineHeight: 1.7, fontSize: '0.98rem' }}>
      ...
      <div className="glass-card" style={{ marginTop: '1.25rem', padding: '1.5rem 1.75rem' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginLeft: 'auto' }}>
            <button
              onClick={toggleMute}
              style={{ background: 'none', border: 'none', color: '#607782', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
              aria-label={isMuted ? "Unmute" : "Mute"}
            >
              {isMuted ? <VolumeX size={18} color="#397D9F" /> : <Volume2 size={18} />}
            </button>
            <input
              type="range"
              min={0}
              ...
              style={{
                ...
                background: `linear-gradient(to right, #78C5E8 ${(isMuted ? 0 : volume) * 100}%, #DDF4FF ${(isMuted ? 0 : volume) * 100}%)`,
                borderRadius: '2px',
                cursor: 'pointer',
                outline: 'none'
              }}
